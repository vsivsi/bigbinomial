...
func TestPMF(t *testing.T) {
	...
	// t.Run("p=0.15,n=10", func(t *testing.T) {
	//    if BinError(0.15, 10) > 1.0e-14 {
	//       t.FailNow()
	//    }
	// })
	...
	t.Run("p=0.15,n=2", func(t *testing.T) {
		if BinError(0.15, 2) > 1.0e-14 {
			t.FailNow()
		}
	})
	t.Run("p=0.15,n=20", func(t *testing.T) {
		if BinError(0.15, 20) > 1.0e-14 {
			t.FailNow()
		}
	})
	t.Run("p=0.15,n=200", func(t *testing.T) {
		if BinError(0.15, 200) > 1.0e-14 {
			t.FailNow()
		}
	})
